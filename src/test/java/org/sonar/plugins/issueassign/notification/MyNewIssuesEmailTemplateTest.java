...
public class MyNewIssuesEmailTemplateTest {
  ...
  public void shouldFormatCommentAdded() {
    ...
    EmailMessage message = template.format(notification);
    assertThat(message.getMessageId()).isEqualTo("my-new-issues/org.apache:struts/user1");
    assertThat(message.getSubject()).isEqualTo("Struts: new issues assigned to you");
    ...
    assertThat(message.getMessage()).contains("|assignees=user1");
  }
